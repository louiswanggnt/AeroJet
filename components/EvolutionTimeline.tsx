...
const carouselImages = [
  { id: 'T3', src: ASSETS.evolution.t3.carousel, label: 'T3 世代' },
  { id: 'T4', src: ASSETS.evolution.t4.carousel, label: 'T4 世代' },
  { id: 'T5', src: ASSETS.evolution.t5.carousel, label: 'T5 世代' },
  { id: 'T6', src: ASSETS.evolution.t6.carousel, label: 'T6 世代' },
];
...
const timelineData = [
  {
    ...
    gun: null, // T3 沒有槍體資料
    control: {
      specs: ['重量 80 kg', '落地型', '含空壓機', '每秒最多 1 發'],
      img: ASSETS.evolution.t3.control
    }
  },
  {
    id: 'T4',
    ...
    gun: {
      ...
      img: ASSETS.evolution.t4.gun
    },
    control: {
      specs: ['重量 5 kg', '桌上型', '每秒最多 2 發'],
      img: ASSETS.evolution.t4.control
    }
  },
  {
    id: 'T5',
    ...
    gun: {
      ...
      img: ASSETS.evolution.t5.gun
    },
    control: {
      specs: ['重量 950 g', '手攜型', '給藥速度分三種燈號', '每秒最多 6 發'],
      img: ASSETS.evolution.t5.control
    }
  },
  {
    id: 'T6',
    ...
    gun: {
      ...
      img: ASSETS.evolution.t6.gun
    },
    control: {
      specs: ['重量 760 g', '手攜型', 'LED螢幕', '每秒最多 10 發'],
      img: ASSETS.evolution.t6.control
    }
  }
];
  ...
  return (
    <section className="py-24 bg-slate-50 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Comparison Table */}
        <div className="mb-24">
          <h3 className="text-2xl font-bold text-center mb-10 text-gray-900">2005~各世代規格對照</h3>
          <div className="overflow-x-auto bg-white rounded-2xl shadow-sm border border-gray-100">
            <table className="w-full text-left border-collapse min-w-[1000px]">
              <thead>
                <tr className="bg-blue-50 text-blue-800">
                  <th className="p-4 font-semibold border-b border-blue-100 whitespace-nowrap">規格參數</th>
                  <th className="p-4 font-semibold border-b border-blue-100 text-red-600">T1</th>
                  <th className="p-4 font-semibold border-b border-blue-100 text-red-600">T2</th>
              ...
              <tbody className="text-gray-600 text-sm">
                <tr className="hover:bg-slate-50 transition-colors">
                  <td className="p-4 border-b border-gray-100 font-medium text-gray-800 whitespace-nowrap">型態</td>
                  <td className="p-4 border-b border-gray-100 text-gray-400">落地型</td>
                  <td className="p-4 border-b border-gray-100 text-gray-400">落地型</td>
                  <td className="p-4 border-b border-gray-100">落地型 <br />(含空壓機)</td>
                  <td className="p-4 border-b border-gray-100">桌上型</td>
                  <td className="p-4 border-b border-gray-100">手攜型</td>
                  <td className="p-4 border-b border-gray-100 font-semibold text-blue-600">手攜型 <br />(LED螢幕)</td>
                </tr>
                <tr className="hover:bg-slate-50 transition-colors">
                  <td className="p-4 border-b border-gray-100 font-medium text-gray-800 whitespace-nowrap">重量</td>
                  <td className="p-4 border-b border-gray-100 text-gray-400">~80kg</td>
                  <td className="p-4 border-b border-gray-100 text-gray-400">~70kg</td>
                  <td className="p-4 border-b border-gray-100">60 kg</td>
                  <td className="p-4 border-b border-gray-100">5 kg</td>
                  <td className="p-4 border-b border-gray-100">1 kg</td>
                  <td className="p-4 border-b border-gray-100 font-semibold text-blue-600">0.76 kg</td>
                </tr>
                <tr className="hover:bg-slate-50 transition-colors">
                  <td className="p-4 border-b border-gray-100 font-medium text-gray-800 whitespace-nowrap">給藥速度</td>
                  <td className="p-4 border-b border-gray-100 text-gray-400">1發/秒</td>
                  <td className="p-4 border-b border-gray-100 text-gray-400">1發/秒</td>
                  <td className="p-4 border-b border-gray-100">2發/秒</td>
                  <td className="p-4 border-b border-gray-100">2發/秒</td>
                  <td className="p-4 border-b border-gray-100">6發/秒</td>
                  <td className="p-4 border-b border-gray-100 font-semibold text-blue-600">10發/秒</td>
                </tr>
                <tr className="hover:bg-slate-50 transition-colors">
                  <td className="p-4 border-b border-gray-100 font-medium text-gray-800 whitespace-nowrap">藥物裝載</td>
                  <td className="p-4 border-b border-gray-100 text-gray-400">針筒</td>
                  <td className="p-4 border-b border-gray-100 text-gray-400">針筒</td>
                ...
                <tr className="hover:bg-slate-50 transition-colors">
                  <td className="p-4 border-b border-gray-100 font-medium text-gray-800 whitespace-nowrap">霧化器</td>
                  <td className="p-4 border-b border-gray-100 text-gray-400" >專利文式管</td>
                  <td className="p-4 border-b border-gray-100 text-gray-400" >專利文式管</td>
                  <td className="p-4 border-b border-gray-100 text-gray-400">專利文式管</td>
                  <td className="p-4 border-b border-gray-100">Type 1 <br />(拋棄式)</td>
                  <td className="p-4 border-b border-gray-100">Type 2 <br />(拋棄式)</td>
                  <td className="p-4 border-b border-gray-100 font-semibold text-blue-600">Type 2 <br />(拋棄式)</td>
                </tr>
                <tr className="hover:bg-slate-50 transition-colors">
                  <td className="p-4 border-b border-gray-100 font-medium text-gray-800 whitespace-nowrap">槍頭設計</td>
                  <td className="p-4 border-b border-gray-100 text-gray-400">固定式</td>
                  <td className="p-4 border-b border-gray-100 text-gray-400">固定式</td>
                  <td className="p-4 border-b border-gray-100 text-gray-400">固定式</td>
                  <td className="p-4 border-b border-gray-100 ">插銷墊片</td>
                  <td className="p-4 border-b border-gray-100 ">插銷墊片</td>
                  <td className="p-4 border-b border-gray-100 font-semibold text-blue-600">磁吸式 <br />(拋棄式)</td>
                </tr>
                <tr className="hover:bg-slate-50 transition-colors">
                  <td className="p-4 font-medium text-gray-800 whitespace-nowrap">單次輸出量</td>
                  <td className="p-4 text-gray-400">3ul</td>
                  <td className="p-4 text-gray-400">3ul</td>
                  <td className="p-4 text-gray-400">3ul</td>
            ...
            <div key={item.id} className="relative mb-16 md:mb-24 last:mb-0">
              <div className="flex flex-col md:grid md:grid-cols-[1fr_auto_1fr] gap-8 items-center">
                ...
                <div className="flex flex-col items-center order-1 md:order-2 z-10 relative">
                  {item.year && (
                    <div className="absolute -top-10 text-gray-400 font-bold text-lg whitespace-nowrap">{item.year}</div>
                  )}
